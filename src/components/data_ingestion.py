...
class DataIngestion:
    '''
    Description: This class is used to ingest data from database and save it in feature store
    ============================================
    Input: data_ingestion_config:config_entity.DataIngestionConfig
    Output: dir will be created in artifacts folder
    =============================================
    '''
